						  ...
						  <tr>
							<td height="813" valign="top">
								...
								<tr>
									...
									<td><form:select path="severity"  cssClass="combo_style">
									...
									<td>
									<form:select path="ownerid"	cssClass="body_text" cssStyle="width:160px;">
								...
								<tr>
									...
									<form:textarea path="headline" cols="56" rows="3"
										id="headline" ></form:textarea></td>
								</tr>
								
								<tr>
									<td class="label_text">Project:</td>
									<td colspan="3">
									<form:select path="projectid" id="projectid" cssStyle="width:468px;" >
								...
								<tr>
									...
									<td>
									<form:select path="priority" cssClass="combo_style" >
								...
								<tr>
									...
									<td colspan="4"><form:textarea path="description"
										id="description" cols="56" rows="3" ></form:textarea>
									</td>
								</tr>
								<tr>
									<td colspan="4" align="center">
									<input type="submit" value="Add Defect" class="button_text" />
