	...
	<div id="contain_body">
		...
		<div id="bodycontent">
			<div id="bdy_cont1">
				...
				<div id="topicon2"><span class="top10">Add Status</span></div>
			...
			<form:form name="testform">
				<table border="0" align="center">
					...
					%>
					<tr>
						<td class="error1" align="center" colspan="2"> <fmt:message key="label.duplicatestatus"/>  </td>
					</tr>
					<%
					}
					%>
					...
					<tr>
						<td class="menutext-h1" align="right">Status Message:</td>
						<td><form:input path="statusname" cssClass="loginsmall" /><label class="error">*</label></td>
					</tr>
					<tr>
						<td></td>
						<td width="200"><form:errors path="statusname" cssClass="error" /></td>
					</tr>
