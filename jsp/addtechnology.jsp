	...
	<div id="contain_body">
		...
		<div id="bodycontent">
			<div id="bdy_cont1">
				...
				<div id="topicon2"><span class="top10">Add Technology</span></div>
			...
			<form:form name="testform">
				<table border="0" align="center">
					...
					%>
					<tr>
						<td class="error1" align="center" colspan="2"> <fmt:message key="label.duplicatetechnology"/>  </td>
					</tr>
					<%
					}
					%>
					...
					<tr>
						...
						<td><form:input path="technologyname" cssClass="loginsmall" /><label class="error">*</label></td>
					</tr>
					<tr>
						<td></td>
						<td width="200"><form:errors path="technologyname" cssClass="error" /></td>
					</tr>
