	...
	<div id="contain_body">
		...
		<div id="bodycontent">
			<div id="bdy_cont1">
				...
				<div id="topicon2"><span class="top10">Add Todos</span></div>
			...
			<form:form name="myform">
				<table border="0" align="center">
					...
					<tr>
						...
						<td>
						<form:select path="assignto" cssClass="loginsmall" cssStyle="width: 138px;">
					...
					<tr>
						...
						<td>
						<form:select path="projectid" cssClass="loginsmall" cssStyle="width: 138px;">
					...
					<tr>
						...
						<td><form:textarea path="description"
							cssClass="loginsmall" rows="3" cols="25" /><label class="error">*</label></td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						<td align="center" colspan="2"><input type="submit"
								value="Save Todos" class="button_text" />&nbsp;&nbsp; <input
