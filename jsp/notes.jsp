						...
						<table width="950" height="813" border="1" bordercolor="#ABCC6A" cellspacing="0" cellpadding="0">
						  <tr>
							<td height="813" valign="top">
								...
								<tr>
									<td class="label_text">	All Notes:</td></tr>
								<tr>
									<td colspan="4">
									<form:textarea path="allnotes"
										id="allnotes" cols="56" rows="13" disabled="true" ></form:textarea>
									</td>
								</tr>
								
								<tr>
									<td class="label_text">	New Notes:</td></tr>
								<tr>
									<td colspan="4">
									<form:textarea path="notes"
										id="notes" cols="56" rows="3" ></form:textarea>
									</td>
								</tr>
